...
#-------------------------------------
#xgboostEndToEndV0.py####python, generate a df,
# using rmse as the loss function and evaluation function####1) with 100 samples,
# not using pairwise####2) each sample has 6 columns, they are user_id, item_id, is_viewed, is_clicked, is_bought, price, short setence for review, grade, time_stamp.
# not using positive samples and negative samples####3）user_id, item_id are randome id, could be duplicated
