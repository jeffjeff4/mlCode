...
####Given a list of tasks [(text, small), (image, large), …] the first element of the tuple is the type of the task and the second element is the model required to finish it.

####Given a fleet of modules {(text, small):3, (image, medium):2, …} the key is model type and size, value is the number of models

####Design a function to return the most efficient allocation of task and model (larger models can finish smaller tasks)
