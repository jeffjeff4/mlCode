...
if __name__ == "__main__":
    ...
    embedding_layer = NumericEmbedding(input_dim=input_dim, embedding_dim=EMBEDDING_DIM)
    transformer_model = TransformerRegressor(input_dim=EMBEDDING_DIM, d_model=64, nhead=4, num_layers=2).to(device)

    # We'll train them end-to-end
    model = nn.Sequential(embedding_layer, transformer_model)
